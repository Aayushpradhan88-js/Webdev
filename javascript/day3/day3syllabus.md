...
1. What is an array?  
   ...
   c. Array Methods (must-know)
        ...
        - find() 
        - filter() 
   assignment: Research and try other array methods (unshift,shift,includes,indexOf etc.)
...
2. Objects
   ...
   b. Creating Objects
    ...
    d. Add, Update, delete properties
    e. Nested Objects
...
#Project
   - Build a simple contact book using array of objects
